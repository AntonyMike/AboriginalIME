...
public class AboriginalKeyboard extends Keyboard {
    ...
    public AboriginalKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }

    public AboriginalKeyboard(Context context, int layoutTemplateResId,
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y,
        ...
        } else if (key.codes[0] == AboriginalKeyboardView.KEYCODE_LANGUAGE_SWITCH) {
